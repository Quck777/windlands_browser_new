...
*Администрация не рекомендует использовать бесплатные сервисы почты, такие как mail.ru, rembler.ru, yandex.ru, так как получение писем может быть невозможным. Рекомендуется использование сервиса gmail.com
</div>
</center>
</body>
</html>