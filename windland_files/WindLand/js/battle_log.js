...
d.write ('<title>Лог Боя['+bid+'] - cb662053.tw1.ru / Страница '+(page+1)+'</title><META Content=\'text/html; charset=windows-1251\' Http-Equiv=Content-type><body class=fightlong>');

var txt = '';
txt += '<center class=logbox>';
txt += '<a class=timef href="/">cb662053.tw1.ru</a> лог боя [№'+bid+']';
