	...
	for (i=0;i<t.length;i++)
	{
		...
		if (txt[6]!=3)
		{
			...
			*/
			...
			{
				s+='<font class=user style="color:#990000">Стражи Закона.</font> '+txt[3]+'<br>';
				att=1;
			...
			{
				s+='<font class=clan>'+txt[0]+'</font> &nbsp;<font class=user style="color:#FF0000">Помощник!</font> '+txt[3]+'<br>';
				att=1;
			//	top.Sound('msg_in',0.5,0);
			}
			else if(txt[1]=='a')
			...
			{
				s+='<span class=red>Квест</span> '+txt[3]+'<br>'; 
				att=1;
			}
			else if(txt[1]=='s')
			{
			...
			{
				s+='<font class=user style="color:#990000">Бой.</font> '+txt[3]+'<br>'; 
				att=1;
			}
