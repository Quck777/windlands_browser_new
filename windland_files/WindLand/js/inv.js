...
$("#container1").html("<table border=0 width=78% style=\"width:78%\"><tr><td align=center onclick=\"location='main.php?filter_f4=herbal'\" style='cursor:pointer;'><img src=http://"+img_pack+"/gameplay/shop_icons/travy.png><div class=gray>Травы["+_herbal+"]</div></td><td align=center onclick=\"location='main.php?filter_f4=resources'\" style='cursor:pointer;'><img src=http://"+img_pack+"/gameplay/shop_icons/resources.png><div class=gray>Ресурсы["+_resources+"]</div></td><td align=center onclick=\"location='main.php?filter_f4=fish'\" style='cursor:pointer;'><img src=http://"+img_pack+"/gameplay/shop_icons/fish.png><div class=gray>Рыба["+_fish+"]</div></td></tr></table>"+all_link);
else 
