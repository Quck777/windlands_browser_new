...
{
		Sinit_main_layer();
		$('#transfer').html('<form action=main.php method=POST><input type=hidden name=napad_new value='+id+'><b>Напасть с помощью свитка '+name+'?</b><center class=but2>На кого? <INPUT TYPE="text" name=fornickname id=fornickname  maxlength=25 class=login style="width:90%"><br><select size="1" name="za" class=real style="width:90%"><option value="0" selected>Против</option><option value="1">За</option></select></center> <input type=submit value="OK" class=login style="width:100%"></FORM>');
        ActionFormUse = 'fornickname';
}
// боевое
...
{
		Sinit_main_layer();
		$('#transfer').html('<form action=main.php method=POST><input type=hidden name=napad_b value='+id+'><b>Напасть с помощью свитка '+name+'?</b><center class=but2>На кого? <INPUT TYPE="text" name=fornickname id=fornickname  maxlength=25 class=login style="width:90%"><br><select size="1" name="za" class=real style="width:90%"><option value="0" selected>Против</option><option value="1">За</option></select></center> <input type=submit value="OK" class=login style="width:100%"></FORM>');
        ActionFormUse = 'fornickname';
}
...
{
		Sinit_main_layer();
		$('#transfer').html('<form action=main.php method=POST><input type=hidden name=prikol value='+id+'><b>Кинуть "'+name+'"?</b><br><b>В кого:</b> <INPUT TYPE="text" name=fornickname id=fornickname  maxlength=25 class=laar><input type=submit value="OK" class=login style="width:100%"></FORM>');
       ActionFormUse = 'fornickname';
}
...
{
	Sinit_main_layer();
	$('#transfer').html('<form action=main.php method=POST><input type=hidden name=scroll value='+id+'><b>Использовать "'+name+'"?</b><br><input type=submit value="OK" class=login style="width:100%"></FORM>');
       ActionFormUse = 'fornicka';
}
function ustal(id,name)
{
		Sinit_main_layer();
		$('#transfer').html('<form action=main.php method=POST><input type=hidden name=ustal value='+id+'><b>Использовать "'+name+'"?</b><br><b>На кого:</b> <INPUT TYPE="text" name=fornickname id=fornickname  maxlength=25 class=laar><input type=submit value="Использовать" class=login style="width:100%"></FORM>');
       ActionFormUse = 'fornickname';
}
...
{
		Sinit_main_layer();
		$('#transfer').html('<form action=main.php method=POST><input type=hidden name=snejok value='+id+'><b>Кинуть "'+name+'"?</b><br><b>В кого:</b> <INPUT TYPE="text" name=fornickname id=fornickname  maxlength=25 class=laar><input type=submit value="Кинуть" class=login style="width:100%"></FORM>');
       ActionFormUse = 'fornickname';
}
...
{
	Sinit_main_layer();
	$('#transfer').html('<form action=main.php method=POST><input type=hidden name=byxlo value='+id+'><b>Выпить "'+name+'"?</b><br><input type=submit value="OK" class=login style="width:100%"></FORM>');
       ActionFormUse = 'fornicka';
}
...
{
		Sinit_main_layer();
		$('#transfer').html('<form action=main.php method=POST><input type=hidden name=antinevid value='+id+'><b>Использовать "'+name+'"?</b><br><b>На кого:</b> <INPUT TYPE="text" name=fornickname id=fornickname  maxlength=25 class=laar><input type=submit value="Использовать" class=login style="width:100%"></FORM>');
       ActionFormUse = 'fornickname';
}
