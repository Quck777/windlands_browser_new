...
{
	return "<table border=0 cellspacing=1 cellspadding=1 width=60><tr><td width=30 class=mf>"+stat+"</td><td width=15><a class=bga style='cursor:pointer' onclick='"+onclick+"(1)' href=#>+</a></td><td width=15><a class=bga style = 'cursor:pointer' onclick='"+onclick+"(-1)' href=#>-</a></td></tr></table>";
}
