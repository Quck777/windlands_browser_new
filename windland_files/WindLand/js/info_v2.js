...
d.write ('<META Http-Equiv=Content-Type Content="text/html; charset=windows-1251"><META Http-Equiv=Cache-Control Content=No-Cache><META Http-Equiv=Pragma Content=No-Cache><META Http-Equiv=Expires Content=0><LINK href=/css/main_v2.css rel=STYLESHEET type=text/css><SCRIPT src="/js/mod/jquery.js"></SCRIPT><script language=javascript src=js/_pers.js></script><script language=javascript src=/js/statsup_v2.js></script><body class=fightlong><form method=post name=del><input type=hidden value="" name=deleterep id=deleterep></form>');
...
else
{
	...
	var inftxt = '<table 0% border=0><tr><td><input class="login" type="button" value="Игровая" onclick="location=\'info.php?'+nick+'&no_watch=1\'" style="width: 110; height: 20; cursor:pointer;" id=but3></td><td width=80% align=center>'+main_onl+online+'</td><td><input class="login" type="button" value="Личная" onclick="location=\'info.php?'+nick+'&no_watch=1&self=1\'" style="width: 110; height: 20; cursor:pointer;" id=but11></td></tr></table>';
	d.write("<center><center style='width:95%'>"+sbox2(inftxt,1)+"</center></center>");
}

function build_pers(sh,shd,oj,ojd,or1,or1d,po,pod,z1,z1d,z2,z2d,z3,z3d,sa,sad,na,nad,pe,ped,or2,or2d,ko1,ko1d,ko2,ko2d,br,brd,pers,inv,align,sign,nick,level,hp,mhp,ma,mma,tire,kam1,kam2,kam3,kam4,kam1d,kam2d,kam3d,kam4d,curh, maxh, curm, maxm, hp_int, ma_int,ss,sl,su,szd,szn,sp,sup,MONEY,dmoney,KB,mf1,mf2,mf3,mf4,mf5,udmin,udmax,rank_i,calling,victories,losses,experience,peace_experience,exp_to_lvl,zeroing,inv,dil,exp_proc,ws1,ws2,ws3,ws4,ws5,ws6,mpr,ISREP,pns,onl)
{
var puns = '';
...
d.write('<title>['+nick+'] cb662053.tw1.ru</title>');
...
show_pers_new(sh,shd,oj,ojd,or1,or1d,po,pod,z1,z1d,z2,z2d,z3,z3d,sa,sad,na,nad,pe,ped,or2,or2d,ko1,ko1d,ko2,ko2d,br,brd,pers,inv,align,sign,nick,level,hp,mhp,ma,mma,tire,kam1,kam2,kam3,kam4,kam1d,kam2d,kam3d,kam4d,inv,dil);
