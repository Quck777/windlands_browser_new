...
// === РЈР»СѓС‡С€РµРЅРёСЏ Р±РѕРµРІРѕР№ СЃРёСЃС‚РµРјС‹ ===

// Р¤СѓРЅРєС†РёСЏ РґР»СЏ РїР»Р°РІРЅРѕРіРѕ РѕР±РЅРѕРІР»РµРЅРёСЏ РїРѕР»РѕСЃРѕРє Р·РґРѕСЂРѕРІСЊСЏ Рё РјР°РЅС‹
...
// Р¤СѓРЅРєС†РёСЏ РїРѕРґСЃРІРµС‚РєРё С‚РµРєСѓС‰РµРіРѕ С…РѕРґР°
function highlight_current_turn() {
    var indicator = document.getElementById('turn_indicator');
    if (indicator && can_turn == 1) {
        indicator.innerHTML = 'Р’Р°С€ С…РѕРґ! Р’С‹Р±РµСЂРёС‚Рµ РґРµР№СЃС‚РІРёРµ';
        indicator.style.display = 'block';
    } else if (indicator) {
        indicator.innerHTML = 'РҐРѕРґ РїСЂРѕС‚РёРІРЅРёРєР°...';
        indicator.style.display = 'block';
    }
}

// Р¤СѓРЅРєС†РёСЏ РґР»СЏ Р°РЅРёРјР°С†РёРё РїРѕР»СѓС‡РµРЅРёСЏ СѓСЂРѕРЅР°
...
// Р¤СѓРЅРєС†РёСЏ РґР»СЏ РѕС‚РѕР±СЂР°Р¶РµРЅРёСЏ РІСЃРїР»С‹РІР°СЋС‰РµРіРѕ С‚РµРєСЃС‚Р° СѓСЂРѕРЅР°
function show_damage_text(x, y, damage, isCritical) {
    var dmgText = document.createElement('div');
    dmgText.className = 'damage_popup';
    dmgText.innerHTML = (isCritical ? 'рџ’Ґ ' : '') + '-' + damage;
...
// Р”РѕР±Р°РІР»СЏРµРј СЃС‚РёР»Рё РґР»СЏ РІСЃРїР»С‹РІР°СЋС‰РµРіРѕ СѓСЂРѕРЅР° РІ CSS
...
// Р¤СѓРЅРєС†РёСЏ Р±С‹СЃС‚СЂРѕРіРѕ РІС‹Р±РѕСЂР° С†РµР»Рё
...
// Р¤СѓРЅРєС†РёСЏ РґР»СЏ РѕС‚РѕР±СЂР°Р¶РµРЅРёСЏ СЃС‚Р°С‚СѓСЃР° Р±РѕСЏ
function show_battle_status() {
    var status = '';
    if (LIFE1 > 0 && LIFE2 > 0) {
        status = '<div class="turn_indicator">Р‘РѕР№ РёРґРµС‚! РљРѕРјР°РЅРґР° 1: ' + LIFE1 + ' | РљРѕРјР°РЅРґР° 2: ' + LIFE2 + '</div>';
    } else if (LIFE1 > 0) {
        status = '<div class="turn_indicator" style="background: linear-gradient(to bottom, #d4edda, #c3e6cb); border-color: #28a745; color: #155724;">РџРѕР±РµРґР° РєРѕРјР°РЅРґС‹ 1!</div>';
    } else if (LIFE2 > 0) {
        status = '<div class="turn_indicator" style="background: linear-gradient(to bottom, #f8d7da, #f5c6cb); border-color: #dc3545; color: #721c24;">РџРѕР±РµРґР° РєРѕРјР°РЅРґС‹ 2!</div>';
    }
    return status;
}

// Р¤СѓРЅРєС†РёСЏ РґР»СЏ РїРѕРґСЃРєР°Р·РѕРє РїРѕ РґРµР№СЃС‚РІРёСЏРј
function show_action_tooltip(action, element) {
    var tooltips = {
        'ug': 'РЈРґР°СЂ РІ РіРѕР»РѕРІСѓ - РІС‹СЃРѕРєРёР№ СѓСЂРѕРЅ, РЅРёР·РєР°СЏ С‚РѕС‡РЅРѕСЃС‚СЊ',
        'ut': 'РЈРґР°СЂ РІ С‚РѕСЂСЃ - СЃСЂРµРґРЅРёР№ СѓСЂРѕРЅ, СЃСЂРµРґРЅСЏСЏ С‚РѕС‡РЅРѕСЃС‚СЊ',
        'uj': 'РЈРґР°СЂ РІ Р¶РёРІРѕС‚ - СЃСЂРµРґРЅРёР№ СѓСЂРѕРЅ, РІС‹СЃРѕРєР°СЏ С‚РѕС‡РЅРѕСЃС‚СЊ',
        'un': 'РЈРґР°СЂ РІ РЅРѕРіРё - РЅРёР·РєРёР№ СѓСЂРѕРЅ, РѕС‡РµРЅСЊ РІС‹СЃРѕРєР°СЏ С‚РѕС‡РЅРѕСЃС‚СЊ',
        'bg': 'Р‘Р»РѕРє РіРѕР»РѕРІРѕР№ - Р·Р°С‰РёС‚Р° РѕС‚ СѓРґР°СЂРѕРІ РІ РіРѕР»РѕРІСѓ',
        'bt': 'Р‘Р»РѕРє С‚РѕСЂСЃРѕРј - Р·Р°С‰РёС‚Р° РѕС‚ СѓРґР°СЂРѕРІ РІ С‚РѕСЂСЃ',
        'bj': 'Р‘Р»РѕРє Р¶РёРІРѕС‚РѕРј - Р·Р°С‰РёС‚Р° РѕС‚ СѓРґР°СЂРѕРІ РІ Р¶РёРІРѕС‚',
        'bn': 'Р‘Р»РѕРє РЅРѕРіР°РјРё - Р·Р°С‰РёС‚Р° РѕС‚ СѓРґР°СЂРѕРІ РІ РЅРѕРіРё'
    };
...
// РРЅРёС†РёР°Р»РёР·Р°С†РёСЏ СѓР»СѓС‡С€РµРЅРёР№ РїСЂРё Р·Р°РіСЂСѓР·РєРµ
...
// Р”РѕР±Р°РІР»СЏРµРј РѕР±СЂР°Р±РѕС‚С‡РёРєРё РґР»СЏ Р·РѕРЅ Р°С‚Р°РєРё/Р·Р°С‰РёС‚С‹
...
// Р—Р°РїСѓСЃРєР°РµРј РёРЅРёС†РёР°Р»РёР·Р°С†РёСЋ РїРѕСЃР»Рµ Р·Р°РіСЂСѓР·РєРё СЃС‚СЂР°РЅРёС†С‹
...
// Р¤СѓРЅРєС†РёСЏ РґР»СЏ РєРѕРјР±Рѕ-СѓРґР°СЂРѕРІ (РЅРѕРІР°СЏ РІРѕР·РјРѕР¶РЅРѕСЃС‚СЊ)
var combo_count = 0;
var last_hit_time = 0;
...
function check_combo() {
    ...
    if (combo_count >= 3) {
        return true; // РљРѕРјР±Рѕ Р°РєС‚РёРІРёСЂРѕРІР°РЅРѕ
    }
    return false;
}

// Р¤СѓРЅРєС†РёСЏ РґР»СЏ СЃРїРµС†РёР°Р»СЊРЅРѕРіРѕ СЂРµР¶РёРјР° Р±РµСЂСЃРµСЂРєР°
var berserk_mode = false;
function toggle_berserk() {
    berserk_mode = !berserk_mode;
    if (berserk_mode) {
        document.body.classList.add('berserk_active');
        return 'Р РµР¶РёРј Р±РµСЂСЃРµСЂРєР° Р°РєС‚РёРІРёСЂРѕРІР°РЅ! РЈСЂРѕРЅ СѓРІРµР»РёС‡РµРЅ, Р·Р°С‰РёС‚Р° СЃРЅРёР¶РµРЅР°.';
    } else {
        document.body.classList.remove('berserk_active');
        return 'Р РµР¶РёРј Р±РµСЂСЃРµСЂРєР° РґРµР°РєС‚РёРІРёСЂРѕРІР°РЅ.';
    }
}

// РЎС‚РёР»Рё РґР»СЏ СЂРµР¶РёРјР° Р±РµСЂСЃРµСЂРєР°
...
console.log('Р‘РѕРµРІР°СЏ СЃРёСЃС‚РµРјР° СѓР»СѓС‡С€РµРЅР°! РќРѕРІС‹Рµ С„СѓРЅРєС†РёРё: update_bars(), highlight_current_turn(), damage_animation(), show_damage_text(), quick_target_select(), show_battle_status(), toggle_berserk()');
