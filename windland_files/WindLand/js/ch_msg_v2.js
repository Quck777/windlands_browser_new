...
function ch_open_menu(event)
{
 ...
 if (molch) watcher_tool = '<tr><td><A class=bg href="javascript:top.Funcy(\'/watchers.php?p='+login+'\')">Смотрителям</A></td></tr><tr><td><A HREF="javascript:silence(\''+login+'\');" class=bg>Молчания</A></td></tr>';
  el.innerHTML = '<table border=0 width=100 class=alt align=center><tr><td class=user align=center style="color:#FFF;">'+login+'</td></tr><tr><td width=100><A HREF="javascript:s_private(\''+login+'\');ch_hmenu();" class=bga>Приват</A></td></tr><tr><td width=100><A HREF="/info.php?'+login2+'" onclick="ch_hmenu();return true;" target=_blank class=bga>Информация</A></td></tr><tr><td><A HREF="javascript:set_ignore(\''+login2+'\');" class=bga width=100>Игнор</A></td></tr>'+watcher_tool+'</table>';
  var upper = 100;
  if (molch) upper += 30;
