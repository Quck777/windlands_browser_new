...
function DialogNav()
{
    ...
    if((QuestStep == QuestDialogLeng) && QuestP[1][0])
    {
        switch(QuestP[1][0])
        {
            case 1: navt += '<a class="block_get" href="javascript: GetQuest(2,'+QuestP[1][1]+');"></a>'; break;
            case 2: navt += '<a class="block_end" href="javascript: GetQuest(3,'+QuestP[1][1]+');"></a>'; break;
        }
    }
    return (navt ? '<BR>'+navt : '');
}
