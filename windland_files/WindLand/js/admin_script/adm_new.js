...
function sec_inf()
{
	...
	z += '<img src="http://'+img_pack+'/money.gif" width=10>Стоимость | <strong class=user onclick="ch_price()"> '+par_val('price')+' LN<br></strong><img src=http://'+img_pack+'/signs/diler.gif  width=10>Стоимость |<strong class=user onclick="ch_price()"> '+par_val('dprice')+' y.e.<br></strong>';
	z += '</td><td width=50%>';
