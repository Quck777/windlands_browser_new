...
function show_pers_new (sh,shd,oj,ojd,or1,or1d,po,pod,z1,z1d,z2,z2d,z3,z3d,sa,sad,na,nad,pe,ped,or2,or2d,ko1,ko1d,ko2,ko2d,br,brd,pers,inv,align,sign,nick,level,hp,mhp,ma,mma,tire,kam1,kam2,kam3,kam4,kam1d,kam2d,kam3d,kam4d,i,dil) {
var d=document;
...
{
	align = align.split(';');
	align = '<img src=http://'+img_pack+'/signs/align/'+align[0]+'.gif title="'+align[1]+'" width="15" height="12"> ';
}
if (sign!='' && sign!='none' )
{
	sign = '<img src="http://'+img_pack+'/signs/'+sign+'.gif" width="15" height="12"> ';
} else sign = '';
...
d.write('</td></tr><tr><td class=table_solid align=center width=100%> '+prvte+' '+align+sign+'<font class=user>'+nick+'</font> <font class=lvl>['+level+']</font>'+dil+' &nbsp; <font class=green title=Усталость>'+parseInt(tire)+'%</font></td> </tr> <tr><td> <table border=0 cellspacing=0 cellpadding=0 width=220> <tr> <td width=30 height=272 valign=bottom> </td><td width=220 align=center><table border=0 cellspacing=0 cellpadding=0 width=220><tr><td width=62 valign=top>');
//d.write('<img src="http://'+img_pack+'/weapons/slots/slot1.gif" width=62 height=20><img src="http://'+img_pack+'/weapons/'+na+'.gif" width=62 height=40 onmouseover="s_des(event,\''+nad+'\')" onmouseout="h_des()" '+naa+' onmousemove=move_alt(event)><img  src=http://'+img_pack+'/weapons/'+pe+'.gif width=62 height=40 onmouseover="s_des(event,\''+ped+'\')" onmouseout="h_des()" '+pea+' onmousemove=move_alt(event)><img  src="http://'+img_pack+'/weapons/'+or1+'.gif" width=62 height=91 onmouseover="s_des(event,\''+or1d+'\')" onmouseout="h_des()" '+or1a+' onmousemove=move_alt(event)><img  src="http://'+img_pack+'/weapons/'+br+'.gif" width=62 height=90 onmouseover="s_des(event,\''+brd+'\')" onmouseout="h_des()" '+bra+' onmousemove=move_alt(event)></td> <td align=center width=115><img src="http://'+img_pack+'/persons/'+pers+'.gif" title="'+nick+'" width=115></td><td width=62 valign=top align=right><img src="http://'+img_pack+'/weapons/'+sh+'.gif" width=62 height=65 onmouseover="s_des(event,\''+shd+'\')" onmouseout="h_des()" '+sha+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+oj+'.gif" width=62 height=35 onmouseover="s_des(event,\''+ojd+'\')" onmouseout="h_des()" '+oja+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+or2+'.gif" width=62 height=91 onmouseover="s_des(event,\''+or2d+'\')" onmouseout="h_des()" '+or2a+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+po+'.gif" width=62 height=30 onmouseover="s_des(event,\''+pod+'\')" onmouseout="h_des()" '+poa+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+sa+'.gif" width=62 height=60 onmouseover="s_des(event,\''+sad+'\')" onmouseout="h_des()" '+saa+' onmousemove=move_alt(event)></td></tr><tr><td align=left width=100%><img src="http://'+img_pack+'/weapons/'+kam1+'.gif" width=31 height=31 onmouseover="s_des(event,\''+kam1d+'\')" onmouseout="h_des()" '+kam1a+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+kam2+'.gif" width=31 height=31 onmouseover="s_des(event,\''+kam2d+'\')" onmouseout="h_des()" '+kam2a+' onmousemove=move_alt(event)></td><td align=center><img src="http://'+img_pack+'/weapons/'+ko1+'.gif" width=31 height=31 onmouseover="s_des(event,\''+ko1d+'\')" onmouseout="h_des()" '+ko1a+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+ko2+'.gif" width=31 height=31 onmouseover="s_des(event,\''+ko2d+'\')" onmouseout="h_des()" '+ko2a+' onmousemove=move_alt(event)></td><td align=right><img src="http://'+img_pack+'/weapons/'+kam3+'.gif" width=31 height=31 onmouseover="s_des(event,\''+kam3d+'\')" onmouseout="h_des()" '+kam3a+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+kam4+'.gif" width=31 height=31 onmouseover="s_des(event,\''+kam4d+'\')" onmouseout="h_des()" '+kam4a+' onmousemove=move_alt(event)></td> <td height=32 align=right valign=bottom></td></tr></table></td> <td width=30 height=272 valign=bottom> </td></tr></table></td></tr></table>');
d.write('<img src="http://'+img_pack+'/weapons/'+sh+'.gif" width=62 height=65 onmouseover="s_des(event,\''+shd+'\')" onmouseout="h_des()" '+sha+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+oj+'.gif" width=62 height=35 onmouseover="s_des(event,\''+ojd+'\')" onmouseout="h_des()" '+oja+' onmousemove=move_alt(event)><img  src="http://'+img_pack+'/weapons/'+or1+'.gif" width=62 height=91 onmouseover="s_des(event,\''+or1d+'\')" onmouseout="h_des()" '+or1a+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+po+'.gif" width=62 height=30 onmouseover="s_des(event,\''+pod+'\')" onmouseout="h_des()" '+poa+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+kam1+'.gif" width=21 height=20 onmouseover="s_des(event,\''+kam1d+'\')" onmouseout="h_des()" '+kam1a+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+kam2+'.gif" width=20 height=20 onmouseover="s_des(event,\''+kam2d+'\')" onmouseout="h_des()" '+kam2a+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+kam3+'.gif" width=21 height=20 onmouseover="s_des(event,\''+kam3d+'\')" onmouseout="h_des()" '+kam3a+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+sa+'.gif" width=62 height=63 onmouseover="s_des(event,\''+sad+'\')" onmouseout="h_des()" '+saa+' onmousemove=move_alt(event)></td> <td align=center width=115><img src="images/persons/'+pers+'.gif" title="'+nick+'" width=115></td><td width=62 valign=top align=right><img src="http://'+img_pack+'/weapons/slots/slot1.gif" width=62 height=12><img src="http://'+img_pack+'/weapons/'+na+'.gif" width=62 height=40 onmouseover="s_des(event,\''+nad+'\')" onmouseout="h_des()" '+naa+' onmousemove=move_alt(event)><img  src=http://'+img_pack+'/weapons/'+pe+'.gif width=62 height=40 onmouseover="s_des(event,\''+ped+'\')" onmouseout="h_des()" '+pea+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+or2+'.gif" width=62 height=91 onmouseover="s_des(event,\''+or2d+'\')" onmouseout="h_des()" '+or2a+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+ko1+'.gif" width=31 height=31 onmouseover="s_des(event,\''+ko1d+'\')" onmouseout="h_des()" '+ko1a+' onmousemove=move_alt(event)><img src="http://'+img_pack+'/weapons/'+ko2+'.gif" width=31 height=31 onmouseover="s_des(event,\''+ko2d+'\')" onmouseout="h_des()" '+ko2a+' onmousemove=move_alt(event)><img  src="http://'+img_pack+'/weapons/'+br+'.gif" width=62 height=90 onmouseover="s_des(event,\''+brd+'\')" onmouseout="h_des()" '+bra+' onmousemove=move_alt(event)></td></tr></table></td></tr></table></td></tr></table>');
...
function s_des (event,id,z) {
	...
	id = '<div class=but style="BACKGROUND: #FFFFFF; ">'+id+'</div>'; //alt
	descr.innerHTML = id;
