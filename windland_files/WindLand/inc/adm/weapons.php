...
<tr><td align=center><script> show_imgs_sell('a=1'); </script><a href=main.php?a=1&set_type=fish class=bg>Рыба
</a></td></tr><tr><td valign="top" align=center>
...
while ($v=mysql_fetch_array ($enures,MYSQL_ASSOC)) 
{
	if( @$_GET["view"]!='l' )
	{
		...
		echo "<td class=user><a href=main.php?edit=".$v["id"]."><img src='http://".IMG."/weapons/".$v["image"].".gif' width='30' height='30'></a>".$v["name"]."<font class=timef>(".$rank_i.") [".$v["index"]."]</font></td>
