...
elseif ($player->pers["noaction"]>=time())
	echo "<div class=return_win>Вы сможете изменить любой пароль через ".tp($player->pers["noaction"]-time())."<br><font class=bnick color=#990000>ТЕКУЩИЙ ЦИФРОВОЙ ПАРОЛЬ: <b>".$player->pers["flash_pass"]."</b></font></div>";
