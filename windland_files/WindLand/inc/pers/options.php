...
for ( $aa=0; $aa<8; $aa+=$tt )
{
	for ( $bb=0; $bb<8; $bb+=$tt )
	{
		for ( $cc=5; $cc<8; $cc+=$tt )
		{
			if ( $opt[5]==dechex($aa).dechex($aa).dechex($bb).dechex($bb).dechex($cc).dechex($cc) )
				echo "<OPTION style='BACKGROUND: #".dechex($aa).dechex($aa).dechex($bb).dechex($bb).dechex($cc).dechex($cc)."' value=".dechex($aa).dechex($aa).dechex($bb).dechex($bb).dechex($cc).dechex($cc)." SELECTED>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</OPTION>"; 
			else echo "<OPTION style='BACKGROUND: #".dechex($aa).dechex($aa).dechex($bb).dechex($bb).dechex($cc).dechex($cc)."' value=".dechex($aa).dechex($aa).dechex($bb).dechex($bb).dechex($cc).dechex($cc).">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</OPTION>";
		}
	}
}
echo "</select></div>";
...
if ($player->pers["obr"]==0)// include ("hero/_avatars_show.php");
{
	...
	{
		if ($i%3==0) echo "<tr>";
		echo "<td class=but><INPUT type=radio value=".$i." name=selectob><br><img height=255 src='http://".IMG."/persons/".$player->pers["pol"]."_".$i.".gif' width=115 border=0></td>"; 
		if ($i%3==2) echo "</tr>";
	}
	echo "</table>";
}
