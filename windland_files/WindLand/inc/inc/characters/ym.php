...
<? if ($player->pers['free_m_skills']<>0)echo '<tr ><td align="center"><i class=user>Свободные второстепенные</i></td><td class=babout><div id=nsymen class=user></div></td></tr>';?>
<tr>
...
?>
<input type=hidden name=nbs id=nbs value=<? echo $player->pers["free_f_skills"];?>><input type=hidden name=nbh id=nbh value=<? echo $player->pers["free_f_skills"];?>>
<input type=hidden name=nss id=nss value=<? echo $player->pers["free_m_skills"];?>><input type=hidden name=nsh id=nsh value=<? echo $player->pers["free_m_skills"];?>>
